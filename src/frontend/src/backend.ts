...
export class Backend implements backendInterface {
    ...
    async getLessonCategories(): Promise<Array<LessonCategory>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLessonCategories();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSupportContactInfo(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getSupportContactInfo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
